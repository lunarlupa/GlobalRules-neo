...
import eu.lunarlupa.globalrules.Config;
import eu.lunarlupa.globalrules.Globalrules;
...
public class GamerulesConfig {
    ...
    public static ConfigValue<com.electronwill.nightconfig.core.Config> modGameRules;
    public static Map<GameRules.Key<?>, ConfigValue<?>> gameRules;
    ...
    public static void init(ModConfigSpec.Builder builder) {
        ...
        GameRules.visitGameRuleTypes(new GameRules.GameRuleTypeVisitor() {
            ...
            public <T extends GameRules.Value<T>> void visit(GameRules.@NotNull Key<T> key, GameRules.@NotNull Type<T> type) {
                ...
                if (name != null && (t instanceof GameRules.BooleanValue || t instanceof GameRules.IntegerValue)) {
                    ...
                    LOGGER.atDebug().log(key + " " + key.getId() + "\n" + type);
                    // Pop the category
                    builder.pop();
                }
            }
        ...
        modGameRules = builder
                ...
                .define("modded", GamerulesConfig::getDefaultModdedGamerules, GamerulesConfig::validateModdedGamerules);

        builder.pop();
    }

    private static com.electronwill.nightconfig.core.Config getDefaultModdedGamerules() {
        return com.electronwill.nightconfig.core.Config.inMemory();
    }

    private static boolean validateModdedGamerules(Object obj) {
    ...
    public static boolean updateModdedGamerules(GameRules rules) {
